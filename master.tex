...
\setauthor[Tiana Razafindralambo]{Tiana Razafindralambo\\
...
\subsection{The Running Correlation Coefficient Computation (RCC)}
...
\begin{figure}[!h]
    \center
    \includegraphics[scale=0.58]{Razafindralambo/img/testwindowsize.png}
...
\begin{figure}[!h]
    \center
    \includegraphics[scale=0.58]{Razafindralambo/img/rcc_window700.png}
...
%In order to have the best RCC trace, one should perform a learning phase. During the latter one
%should compute the RCC several time with different window' size. 
